...
const Contact = () => {
  ...
  return (
    <section id="contact" className="mt-10 w-full bg-base-300 py-12">
      ...
      <div className="w-9/12 mx-auto flex flex-col md:flex-row justify-between items-center gap-5">
        <div className="md:w-1/2 w-full mx-auto flex flex-col gap-3">
        ...
        <form onSubmit={handleSubmit} className="md:w-1/2 w-full">
          ...
          <input
            ...
            placeholder="Name"
            required
            className="w-full mb-4 px-4 py-2 rounded-lg border placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"
          />
          ...
          <textarea
            ...
            className="w-full mb-4 px-4 py-2 rounded-lg border placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-400 transition"></textarea>

          <div className="flex items-center gap-3">
            <button
              type="submit"
              disabled={loading}
              className="disabled:cursor-not-allowed px-5 py-2 rounded-lg bg-amber-500 font-semibold hover:bg-amber-600 transition-all">
              Send Message
            </button>
          </div>
        </form>
